...
static inline int
xd3_emit_uint64_t(xd3_stream *stream, xd3_output **output, uint64_t num) { EMIT_INTEGER_TYPE (); }
...
static inline uint32_t xd3_sizeof_size(usize_t num) { return xd3_sizeof_uint64_t(num); }
